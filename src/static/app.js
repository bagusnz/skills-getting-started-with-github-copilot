                ...
                details.participants.length > 0
                  ? details.participants.map((participant) => `
                    <div class="participant-pill" data-activity="${name}" data-email="${participant}">
                      ...
                      <button class="delete-participant" type="button" aria-label="Remove ${participant}" title="Remove ${participant}">×</button>
                    </div>
                  `).join("")
                  : '<div class="participant-pill empty">Be the first to join!</div>'
              }
            </div>
          </div>
        `;
